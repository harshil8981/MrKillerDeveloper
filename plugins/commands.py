...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/Hpbot_update')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/Movie_Flix_Zone"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@TechnicalHPgamer')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
